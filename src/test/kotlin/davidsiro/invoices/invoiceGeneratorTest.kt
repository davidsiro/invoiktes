                              ...
                              <div class="card">
                                <div class="card-block">
                                  ...
                                  <div class="card-footer">
                                    <h4 class="text-right">Celkem v EUR<small class="text-muted translated"> (Total due in EUR) </small>: 510791.60</h4>
                                    <h4 class="text-right">Celkem v CZK<small class="text-muted translated"> (Total due in CZK) </small>: 13076264.96</h4>
                                  </div>
                                </div>
                              </div>
                            </div>
